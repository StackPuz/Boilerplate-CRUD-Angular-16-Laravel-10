# Backend-CRUD-Angular-16-Laravel-10
Boilerplate Backend CRUD Web App created with Angular 16 + Laravel 10 by [StackPuz](https://stackpuz.com).
...
## Installation
1. Clone this repository. `git clone https://github.com/stackpuz/Backend-CRUD-Angular-16-Laravel-10.git .`
2. Change directory to Angular project. `cd Backend-CRUD-Angular-16-Laravel-10/angular`
