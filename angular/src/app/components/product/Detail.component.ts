          ...
          <div ngNativeValidate method="post">
            <div class="row">
              ...
              <div class="form-group col-md-6 col-lg-4"><label>Image</label>
                <div><a href="http://localhost:8000/storage/products/{{product.image}}" target="_blank" title="{{product.image}}"><img class="img-item" src="http://localhost:8000/storage/products/{{product.image}}" /></a></div>
              </div>
              <div class="col-12">
