          ...
          <form ngNativeValidate method="post" (submit)="edit()" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="form-group col-md-6 col-lg-4">
                ...
                <a href="http://localhost:8000/storage/products/{{product.image}}" target="_blank" title="{{product.image}}"><img class="img-item" src="http://localhost:8000/storage/products/{{product.image}}" /></a>
