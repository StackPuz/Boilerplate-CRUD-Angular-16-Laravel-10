            ...
            <table class="table table-sm table-striped table-hover">
              ...
              <tbody>
                <tr *ngFor="let product of products">
                  ...
                  <td class="d-none d-md-table-cell text-center"><a *ngIf="product.image" href="http://localhost:8000/storage/products/{{product.image}}" target="_blank" title="{{product.image}}"><img class="img-list" src="http://localhost:8000/storage/products/{{product.image}}" /></a></td>
                  <td>{{product.name}}</td>
                  ...
                  <td class="text-center">
                    ...
                    <a class="btn btn-sm btn-danger" href="#!" (click)="deleteItem($event, product.id)" title="Delete"><i class="fa fa-times"></i></a>
                  </td>
                </tr>
              </tbody>
            </table>
