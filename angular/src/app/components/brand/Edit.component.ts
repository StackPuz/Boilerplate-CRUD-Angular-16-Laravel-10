                  ...
                  <tbody>
                    <tr *ngFor="let brandProduct of brandProducts">
                      ...
                      <td class="text-center">
                        ...
                        <a class="btn btn-sm btn-danger" href="#!" (click)="deleteItem($event, '/products/' + brandProduct.id)" title="Delete"><i class="fa fa-times"></i></a>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
export class BrandEdit {
  ...
  brandProducts?: any[]
  errors?: any = {}
  constructor(private router: Router, private route: ActivatedRoute, private BrandService: BrandService, private http: HttpClient, public util: Util) { }
