              ...
              <tbody>
                <tr *ngFor="let orderHeader of orderHeaders">
                  ...
                  <td class="text-center">
                    ...
                    <a class="btn btn-sm btn-danger" href="#!" (click)="deleteItem($event, orderHeader.id)" title="Delete"><i class="fa fa-times"></i></a>
                  </td>
                </tr>
              </tbody>
            </table>
...
export class OrderHeaderIndex {
  ...
  deleteItem(e: Event, id: any) {
    ...
    if (confirm('Delete this item?')) {
      this.OrderHeaderService.delete(id, true).subscribe(() => {
        this.get()
      }, (e) => {
        alert(e.error.message)
      })
