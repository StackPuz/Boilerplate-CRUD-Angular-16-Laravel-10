              ...
              <tbody>
                <tr *ngFor="let userAccount of userAccounts">
                  ...
                  <td class="text-center">
                    ...
                    <a class="btn btn-sm btn-danger" href="#!" (click)="deleteItem($event, userAccount.id)" title="Delete"><i class="fa fa-times"></i></a>
                  </td>
                </tr>
              </tbody>
            </table>
...
export class UserAccountIndex {
  ...
  deleteItem(e: Event, id: any) {
    ...
    if (confirm('Delete this item?')) {
      this.UserAccountService.delete(id, true).subscribe(() => {
        this.get()
      }, (e) => {
        alert(e.error.message)
      })
